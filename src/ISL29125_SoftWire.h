...
This header file declares the ISL29125_SOFT sensor class as well as its various
...
#ifndef ISL29125_SOFT_h
#define ISL29125_SOFT_h
...
{
 public:
  ISL29125_SOFT(uint8_t addr = ISL_I2C_ADDR);
  ~ISL29125_SOFT();
